...
/**
 * This is a client side application which utilizes both WiFi-Direct & Bluetooth wireless interfaces to simultaneously transmit some data
 * across to another phone. This file is the main activity which starts everything and registers the WiFi-Direct broadcast receiver.
 * 
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Changing thread policy to allow for wireless interface transmission.
		...
		// Register application with WiFi P2p framework.
	    ...
	    myWifiDirectManager.discoverPeers(this.myWifiDirectChannel, new WifiP2pManager.ActionListener() {
	        ...
	        public void onSuccess() {
	            Log.i("Charbel", "Discovered Other WifiDirect Devices");
	            MainActivity.this.textView2.setText("Discovered Other WifiDirect Devices");
	        }
	...
	// Register the broadcast receiver & intent values to be matched when Activity starts up.
	@Override
	protected void onResume() {
	    super.onResume();
	    registerReceiver(myWifiDirectReceiver, myIntentFilter);
	}
